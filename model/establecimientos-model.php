<?php
    ...
    class UsuarioM extends DBAbstractModel
    {
        ...
        public function allUser(){
            $this->query="SELECT * FROM establecimientos";
            ...
            if(count($this->rows) > 0){
                ...
                return [
                    "datos"=>"No se encontraron establecimientos"
                ];
            }
        }
        ...
        public function getUserById($array){
            $this->query="SELECT * FROM establecimientos where establecimientos.id_estab = $array->id_estab";
            $this->get_results_from_query();
            if(count($this->rows) > 0){
                return [
                    "datos"=>$this->rows[0]
