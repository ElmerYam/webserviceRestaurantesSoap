<?php
    require 'model/establecimientos-model.php';
    class Usuario{
        ...
        public function index(){
			return $elmer = array('id_estab'=>12,'opcion'=>"all",'controlador'=>"establecimientos");
		}
        ...
        public function post($parametros){
            ...
            if(!empty($parametros)){
                ...
                default:
                 return $elmer = array('error'=>"no hay metodo",'controlador'=>"establecimientos");
                break;
                }
            }
        }
